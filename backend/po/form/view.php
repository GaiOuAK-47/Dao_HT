...
try {
    ...
    $sql = "SELECT a.pocode,a.supcode,c.supname,podate,deldate,payment,currency,poqua,vat,a.remark,code,pono,b.stcode,d.stname1,b.amount,b.price,b.unit,supstatus,b.unit,b.discount,recamount";
    ...
    $data = array(       
        ...
        {            
            ...
            array_push($data['pocode'],$row['pocode']);
            array_push($data['supcode'],$row['supcode']); 
            array_push($data['supname'],$row['supname']);            
            array_push($data['podate'],$row['podate']);
            array_push($data['address'],$address);
            array_push($data['tel'],$row['tel']);
            array_push($data['deldate'],$row['deldate']);
            array_push($data['payment'],$row['payment']);
            array_push($data['poqua'],$row['poqua']);
            array_push($data['vat'],$row['vat']);
            array_push($data['remark'],$row['remark']);
            array_push($data['pono'],$row['pono']);
                        ...
                        <div class="list-detail">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    for($count=0;$count<count($data["pocode"]);$count++)  {

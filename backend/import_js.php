...
<script src="<?php echo PATH; ?>/backend/AdminLTE-3.2.0/plugins/moment/moment.min.js"></script>
<script src="<?php echo PATH; ?>/backend/AdminLTE-3.2.0/plugins/bs-stepper/js/bs-stepper.min.js"></script>
...
<script>
    ...
    const toast = (message="Message",type="info") => Toast.fire({icon: type, title: message });

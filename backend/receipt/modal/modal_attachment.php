                ...
                <div class="col-sm-12 col-12">
                    <div class="form-row">
                        <div class="form-group col-md-12 col-sm-12">
                            ...
                            <input type="text" accept="image/*" class="form-control" name="attname" id="attname" placeholder="กรุณากรอก หัวข้อไฟล์" req>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-12 col-sm-12 mt-4 mb-2">
                            ...
                            <input type="file" accept="image/*" class="custom-file-input d-none" name="atthFile"

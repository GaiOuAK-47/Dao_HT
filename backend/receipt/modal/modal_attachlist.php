    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content w3-flat-turquoise">
            <div class="modal-header">
                <h5 class="modal-title">แนบไฟล์</h5>
                ...
                <div class="section-attach-file">
                    <div class="card">
                        <div class="card-header border-0 w-100 d-flex align-items-center justify-content-between">
                            <h4 class="card-title text-left col-6" style="font-size: 0.9rem; font-weight: 600;">รายการ ไฟล์แนบ
                            </h4>
            ...
            <div class="modal-footer">
                <div class="col text-center">
                    ...
                    <button type="button" style="color:white;background:#7e57c2;text-shadow:2px 2px 4px #000000;" class="btn" onclick="uploadAttachment(event)">ยืนยันการแนบไฟล์เอกสาร</button>
                </div>
            </div>
        </div>
    </div>
